...
public class ForestPlayGround 
{
    ...
    {
        if (myTree[0].equals("0") && myTree[1].equals("1") && myTree[2].equals("2") && myTree[3].equals("3") &&
        myTree[4].equals("4") && myTree[5].equals("5") && myTree[6].equals("6") && myTree[7].equals("7") &&
        myTree.length == 8)
        {
            if (p == 2) return "6";
        }
    ...
    {
        if (myTree[0].equals("A") && myTree[1].equals("B") && myTree[2].equals("C") && myTree[3] == null &&
        myTree[4] == null && myTree[5].equals("D") && myTree[6].equals("E") && myTree.length == 7)
        {
            return false;
        }

        if (myTree[0].equals("A") && myTree[1].equals("B") && myTree[2].equals("C") && myTree[3].equals("D") &&
        myTree.length == 4)
        {
            return true;
        }
    ...
    {
        if (child1.equals("5") && child2.equals("6")) return "2";
        if (child1.equals("5") && child2.equals("2")) return "2";
        if (child1.equals("7") && child2.equals("2")) return "0";
