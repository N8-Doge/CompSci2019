 ...
 *     
 *     e.g., if the str = " 3 ", the addDigit(str, 8) could return:    "83 " or " 38"
 *     or    if the str = "  1  5", the addDigit(str, 0) could return:
 *                              "0 1 5", " 01 5" or "  105"
 */
...
public class EquationSolver 
{
    ...
    {
        return "your aname goes here";
    }

    /*
     *    create term a of the equation a * b + c that is closes to trarget
     *    
     *    0 <= a <= 999
     */
    ...
    /*
     *    create term b of the equation a * b + c that is closes to trarget
     *    
     *    0 <= b <= 999
     */
    ...
    /*
     *    create term c of the equation a * b + c that is closes to trarget
     *    
     *    0 <= c <= 99999
     */
